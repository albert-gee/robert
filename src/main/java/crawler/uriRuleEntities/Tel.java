 ...
 */
public class Tel implements UriInterface {

    private String              scheme;
    private String              uri;
    private Set<UriInterface>   parents;

    public Tel(String scheme, String uriString, UriInterface parent) {
    ...
    public void setUri(String uriString) {
        if (uriString == null) throw new IllegalArgumentException("Tel URI is null");
    ...
    public void actionAfterUriAddedToBuffer(Crawler crawler) {
        System.out.println("New Tel URI has been added to the buffer: " + this.getUri());
    }
